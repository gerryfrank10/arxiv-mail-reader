      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-900 text-center px-8">
        <div className="max-w-sm">
          ...
          <p className="text-slate-400 text-sm leading-relaxed mb-4">
            Create a <code className="text-slate-300 bg-slate-800 px-1 rounded">.env</code> file with your Google OAuth client ID:
          </p>
          <pre className="text-left bg-slate-800 text-green-400 text-xs px-4 py-3 rounded-lg border border-slate-700">
            VITE_GOOGLE_CLIENT_ID=your-client-id
          </pre>
          <p className="text-slate-500 text-xs mt-4">See README.md for full setup instructions.</p>
        </div>
      </div>
    );
  }
